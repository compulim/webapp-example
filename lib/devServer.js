...
class DevServer {
  ...
  listen() {
    ...
    console.log(require(config.SOURCE_WEBPACK_CONFIG_FILE));
    ...
    console.log(JSON.stringify(webpackConfigurator._webpackConfig, null, 2));
    console.log(webpackConfigurator.devServerConfig());
